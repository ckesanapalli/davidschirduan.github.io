---
layout: page
title: Solar Blades Character Generator
permalink: /sbcschargen
published: false
image: /images/generatorPreview.png
---

<p>A character generator for <a href="https://www.drivethrurpg.com/product/260378/Solar-Blades--Cosmic-Spells">Solar Blades & Cosmic Spells</a>, but you may find it useful for other OSR sci-fi games.</p>
...
<div class="container generatorCard">
  ...
  <div class="row">
		<div class="col-xl-3 col-md-6 tightSpacing h3" id="charPHY">Physique: 9</div>
		<div class="col-xl-3 col-md-6 tightSpacing h3" id="charAGI">Agility: 8</div>
		<div class="col-xl-3 col-md-6 tightSpacing h3" id="charINT">Intellect: 7</div>
		<div class="col-xl-3 col-md-6 tightSpacing h3" id="charWIL">Willpower: 6</div>
	</div>
...
function generate(knave) {
  ...
  document.getElementById("charPHY").innerText = "Physique: " + (die1 + die2 + die3);
  var die1 = Math.floor(Math.random() * 6) + 1;
  var die2 = Math.floor(Math.random() * 6) + 1;
  var die3 = Math.floor(Math.random() * 6) + 1;
  document.getElementById("charAGI").innerText = "Agility: " + (die1 + die2 + die3);
  var die1 = Math.floor(Math.random() * 6) + 1;
  var die2 = Math.floor(Math.random() * 6) + 1;
  var die3 = Math.floor(Math.random() * 6) + 1;
  document.getElementById("charINT").innerText = "Intellect: " + (die1 + die2 + die3);
  var die1 = Math.floor(Math.random() * 6) + 1;
  var die2 = Math.floor(Math.random() * 6) + 1;
  var die3 = Math.floor(Math.random() * 6) + 1;
  document.getElementById("charWIL").innerText = "Willpower: " + (die1 + die2 + die3);
